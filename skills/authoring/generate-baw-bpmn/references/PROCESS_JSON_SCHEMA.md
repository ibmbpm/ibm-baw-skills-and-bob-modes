...
Avoid `< > & " \ / : * ? |` in the name — BAW rejects these characters in artifact names.
...
`maxOccurs="unbounded"`. The generator orders the XSD so that referenced types appear first.
